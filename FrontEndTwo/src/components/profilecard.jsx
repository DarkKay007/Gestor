    ...
    <>
      <Card className="w-80 h-64 bg-yellow-400 rounded-xl hover:bg-yellow-200 ">
        <div className="flex justify-end px-20  pt-4 text-gray-900">
          <Dropdown className=' bg-gray-900' inline label="">
          ...
          <div className="text-center ">
            ...
            <div className="flex flex-col items-center gap-4">
              <select
                ...
                className="form-select mt-1 block w-full py-2 px-3 border border-gray-300  rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-900 bg-gray-700"
              >
